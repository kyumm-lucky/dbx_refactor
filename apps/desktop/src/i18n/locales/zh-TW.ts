...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    // 分頁右鍵選單固定 6 項的短文案。
    tabMenuFullTitle: "完整標題",
    tabMenuShortTitle: "縮短標題",
    tabMenuLocate: "定位",
    tabMenuCloseOthers: "關閉其他",
    tabMenuCloseAllLeft: "關閉左側所有",
    tabMenuCloseAllRight: "關閉右側所有",
    tabMenuCloseAll: "全部關閉",
    copyName: "複製名稱",
    name: "名稱",
    fullPath: "完整路徑",
  ...
  settings: {
    ...
    accentGreen: "綠色",
    accentRed: "紅色",
    cornerStyleStandard: "標準",
    cornerStyleCompact: "緊湊",
    customUiReset: "恢復預設",
