...
export default {
  ...
  contextMenu: {
    ...
    // Fixed labels of the tab context menu (six entries, short wording).
  ...
  settings: {
    ...
    themePaletteGraphite: "Graphite",
    themePaletteCustom: "Custom",
    themePaletteSystem: "System",
    ...
    accentGreen: "Green",
    accentRed: "Red",
    cornerStyleStandard: "Standard",
    cornerStyleCompact: "Compact",
